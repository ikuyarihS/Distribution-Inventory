...
#pragma warning restore 1587
                    ...
                    if (supplierType != "VinEco" && product.ProductCode.Substring(0, 1) != "K" && (priorityTarget == "VM" || priorityTarget == "VM+"))
                    {
                    ...
                    double SumTarget = coreStructure.dicPO[datePo][product]
                        .Where(
                            x =>
                                ...
                                && x.Value
                                && (priorityTarget == string.Empty || coreStructure.dicCustomer[x.Key.CustomerId].CustomerType == priorityTarget)
                                && CheckDaNang(x))
                    ...
                    if (supplierRegion == "Lâm Đồng")
                    {
                        ...
                        if (coreStructure.dicPO.ContainsKey(_DatePO) && coreStructure.dicPO[_DatePO].ContainsKey(product))
                        {
                        ...
                        if (supplierRegion != "Lâm Đồng" && _dicProductFcLd.Value != null)
                        {
                            ...
                            if (dicSupplierLdFC.Value != null)
                            {
                                ...
                                flagFullOrder = dicSupplierLdFC.Value
                                    .Any(
                                        x =>
                                            coreStructure.dicSupplier[x.Key.SupplierId].SupplierRegion == "Lâm Đồng" && (x.Key.Target == "All" || x.Key.Target == priorityTarget) && x.Key.FullOrder);
                            }
                        }
                        ...
                        if (dicSupplierFC.Value != null)
                        {
                            ...
                            if (!flagFullOrder)
                                flagFullOrder = dicSupplierFC.Value
                                    .Any(
                                        x =>
                                            coreStructure.dicSupplier[x.Key.SupplierId].SupplierRegion == supplierRegion && (x.Key.Target == "All" || x.Key.Target == priorityTarget) && x.Key.FullOrder);
                            ...
                            DateTime _DatePO = supplierRegion == "Miền Bắc"
                                                   ...
                                                   : datePo.AddDays(2).Date;
                            if (customerRegion == "Miền Nam" && coreStructure.dicPO.ContainsKey(_DatePO) && coreStructure.dicPO[_DatePO].ContainsKey(product))
                                sumVE += Math.Max(
                                    sumFarmLd
                                    + sumThuMuaLd
                                    - coreStructure.dicPO[_DatePO][product]
                            ...
                            if (sumVE > 0)
                            {
                                ...
                                else if (!flagFullOrder)
                                {
                                    ...
                                    if (rate < 1)
                                    {
                                        ...
                                        if (rate < 1)
                                        {
                                            rate = supplierRegion != "Lâm Đồng" && (yesNoKpi || sumFarm > 0 || sumFarmLd > 0 || sumThuMua > 0 || sumThuMuaLd > 0)
                                                       ? Math.Max(rate, 1)
                                                       : rate;
                                        }

                                        if (supplierRegion == "Lâm Đồng" && rate < 1 && priorityTarget == string.Empty)
                                        {
                                ...
                                foreach (CustomerOrder customerOrder in coreStructure.dicPO[datePo][product]
                                        ...
                                        .Where(
                                            x =>
                                                coreStructure.dicCustomer[x.CustomerId].CustomerBigRegion == customerRegion && (priorityTarget == string.Empty || coreStructure.dicCustomer[x.CustomerId].CustomerType == priorityTarget) && (x.DesiredRegion == null || x.DesiredRegion == supplierRegion) && (x.DesiredSource == null || x.DesiredSource == supplierType))
                                    ...
                                    if (true)
                                    {
                                        ...
                                        IEnumerable<KeyValuePair<SupplierForecast, bool>> result = _dicSupplierFC_inner
                                            .Where(
                                                x =>
                                                    yesNoKpi
                                                        ? x.Key.QuantityForecastPlanned >= customerOrder.QuantityOrderKg * rate
                                                        : yesNoContracted
                                                            ? x.Key.QuantityForecastContracted >= customerOrder.QuantityOrderKg * rate
                                                            : x.Key.FullOrder || x.Key.QuantityForecast >= customerOrder.QuantityOrderKg * rate);
                                        ...
                                        if (totalSupplier != 0)
                                        {
                                            SupplierForecast _result = result.Aggregate(
                                                    (l, r) =>
                                                        coreStructure.dicDeli[datePo.AddDays(-dayBefore)][product][l.Key] < coreStructure.dicDeli[datePo.AddDays(-dayBefore)][product][r.Key]
                                                            ? l
                                                            : r)
                                                .Key;
                                        ...
                                        if (!coreStructure.dicCoord.TryGetValue(
                                                datePo,
                                                out Dictionary<Product, Dictionary<CustomerOrder, Dictionary<SupplierForecast, DateTime>>> _dicCoordProduct)) continue;
                                        if (!_dicCoordProduct.TryGetValue(
                                                product,
                                                out Dictionary<CustomerOrder, Dictionary<SupplierForecast, DateTime>> _dicCoordCusSup))
                                            continue;
                                        ...
                                        if (wallet < moq && priorityTarget != string.Empty) wallet = moq;
                                            ...
                                            _SupplierForecast.QuantityForecast >= moq)
                                        {
                                            ...
                                            if (crossRegion
                                                ...
                                                && customerRegion == "Miền Bắc"
                                                && supplierRegion == "Miền Nam" /*&& _Product.ProductCode.Substring(0, 1) == "K"*/
        ...
        /// The coord caller.
        /// </summary>
        /// <param name="coreStructure">
        /// The core structure.
        /// </param>
        /// <param name="listRegion">
        /// The list region.
        /// </param>
        /// <param name="supplierType">
        /// The supplier type.
        /// </param>
        /// <param name="upperLimit">
        /// The upper limit.
        /// </param>
        /// <param name="priorityTarget">
        /// The priority target.
        /// </param>
        /// <param name="YesNoByUnit">
        /// The yes no by unit.
        /// </param>
        /// <param name="YesNoContracted">
        /// The yes no contracted.
        /// </param>
        /// <param name="YesNoKPI">
        /// The yes no kpi.
        /// </param>
            ...
            bool YesNoKPI = false)
        {
            for (var index = 0; index < listRegion.Length; index++)
            {
                ...
                // upperLimitLocal = 1.1;
                if (priorityTarget.Contains("VM+") && this.UpperCap > 0)
                {
                ...
                if (priorityTarget != "B2B" && this.UpperCap <= -1)
                {
                    upperLimitLocal = -1;
                }
                ...
                // ReSharper disable once SwitchStatementMissingSomeCases
                if (supplierType == "VCM" || (supplierType == "ThuMua" && this.UpperCap <= -1))
                {
                    upperLimitLocal = 1;
                }
                ...
                if (this.UpperCap > 0)
                {
                    upperLimitLocal = Math.Min(upperLimitLocal, this.UpperCap);
                }
        ...
        private DateTime? StringToDate(string suspect)
        {
            ...
            if (this._dicDate.TryGetValue(suspect, out DateTime dateResult))
            {
            ...
            if (!DateTime.TryParse(suspect, out DateTime date))
            {
                ...
                this._dicDate.Add(suspect, DateTime.MinValue);
                return null;
            }

            // Welp, it's actually a date.
            // Record the string anyway. Dis many importanto.
            this._dicDate.Add(suspect, date);
            return date;
        }
    }
}
    ...
    public partial class MainForm : Form
    {
        ...
        private void PrintPO(string Choice, bool YesNoByUnit = false)
        {
            try
            {
                ...
                var path = @"C:\Users\Shirayuki\Documents\VinEco\Project - Chia Hang\Mastah Project\Test\";
            ...
            for (var index = 0; index < ListRegion.GetUpperBound(1); index++)
            {
                ...
                WriteToRichTextBoxOutput(
                    string.Format("{0} => {1}, {2}{3}",
                        string.Concat(ListRegion[index, 0].ToString().Split(' ').Select(x => x.First())),
                        string.Concat(ListRegion[index, 1].ToString().Split(' ')
                            .Select(x => x.First().ToString().ToUpper())), SupplierType,
                        PriorityTarget != "" ? " " + PriorityTarget : ""), false);

                WriteToRichTextBoxOutput(string.Format(" UpperLimit = {1} - Done in {0}s!",
                    Math.Round(stopwatch.Elapsed.TotalSeconds, 2), UpperLimit));
            ...
            bool YesNoReportM1 = false, bool YesNoByUnit = false, bool YesNoOnlyFarm = false)
        {
            try
            {
                ...
                var Product = db.GetCollection<Product>("Product").AsQueryable().ToList().ToArray();
                var Supplier = db.GetCollection<Supplier>("Supplier").AsQueryable().ToList().ToArray();
                var Customer = db.GetCollection<Customer>("Customer").AsQueryable().ToList().ToArray();
                ...
                coreStructure.dicPO =
                    new Dictionary<DateTime, Dictionary<Product, Dictionary<CustomerOrder, bool>>>(PO.Count() * 4);
                var dicUnit = new Dictionary<string, string>(StringComparer.Ordinal);
                ...
                coreStructure.dicCoord =
                    new Dictionary<DateTime, Dictionary<Product,
                        Dictionary<CustomerOrder, Dictionary<SupplierForecast, DateTime>>>>(PO.Count() * 4);
                foreach (var PODate in PO)
                {
                ...
                if (!YesPlanningFuckMe)
                {
                    ...
                    {
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit, false, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit, false, true);
                    ...
                    if (!YesNoOnlyFarm)
                    {
                        ...
                        CoordCaller(coreStructure, ListRegion, "ThuMua", 1, "VM+ VinEco", YesNoByUnit, true);
                    }
                    ...
                    if (!YesNoOnlyFarm)
                    {
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VCM", 1, 2, UpperCap, false, "VM+", YesNoByUnit);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "VCM", 0, 0, UpperCap, false, "VM+", YesNoByUnit);
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VCM", 1, 2, UpperCap, false, "VM", YesNoByUnit);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "VCM", 0, 0, UpperCap, false, "VM", YesNoByUnit);
                    ...
                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, 1, true, "VM+ VinEco", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, 1, true, "VM+ VinEco", YesNoByUnit, false, true);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM+ Priority", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM+ Priority", YesNoByUnit, false, true);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM Priority", false, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM Priority", false, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM Priority", false, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM Priority", false, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM Priority", false, false, true);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM Priority", false, false, true);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM+", YesNoByUnit, false, true);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM+", YesNoByUnit, false, true);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM", false, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM", false, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM", false, false, true);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM", false, false, true);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM", false, false, true);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM", false, false, true);

                    CoordCaller(coreStructure, ListRegion, "VinEco", UpperCap, "VM+ Priority", YesNoByUnit, false,
                        true);
                    ...
                    {
                        // KPI first
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, 1, true, "VM+ VinEco", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, 1, true, "VM+ VinEco", YesNoByUnit, false, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+ Priority", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+ Priority", YesNoByUnit, false, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM Priority", false, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM Priority", false, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM Priority", false, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM Priority", false, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM Priority", false, false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM Priority", false, false, true);
                        ...
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, 1, true, "VM+ VinEco", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, 1, true, "VM+ VinEco", YesNoByUnit, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+ Priority", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+ Priority", YesNoByUnit, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM Priority", false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM Priority", false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM Priority", false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM Priority", false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM Priority", false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM Priority", false, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+", YesNoByUnit, false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+", YesNoByUnit, false, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM", false, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM", false, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM", false, false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM", false, false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM", false, false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM", false, false, true);
                        ...
                        // Contracted afterward
                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+", YesNoByUnit, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+", YesNoByUnit, true);

                        //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM", false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM", false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM", false, true);
                        //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM", false, true);
                        //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM", false, true);
                        //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM", false, true);
                    }
                ...
                if (!YesNoCompact & !YesNoOnlyFarm)
                {
                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, 1, false, "B2B", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, 1, false, "B2B", YesNoByUnit);
                ...
                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, 1, true, "VM+ VinEco", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, 1, true, "VM+ VinEco", YesNoByUnit);

                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM+ Priority", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM+ Priority", YesNoByUnit);

                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM+", YesNoByUnit);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM+", YesNoByUnit);

                if (!YesNoOnlyFarm)
                {
                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, 1, false, "VM+ VinEco", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, 1, false, "VM+ VinEco", YesNoByUnit);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, 1, true, "VM+ VinEco", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, 1, true, "VM+ VinEco", YesNoByUnit);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+ Priority", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+ Priority", YesNoByUnit);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+ Priority", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+ Priority", YesNoByUnit);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM+", YesNoByUnit);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM+", YesNoByUnit);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM+", YesNoByUnit);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM+", YesNoByUnit);
                ...
                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM Priority", false);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM Priority", false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM Priority", false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM Priority", false);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM Priority", false);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM Priority", false);

                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false, "VM", false);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false, "VM", false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false, "VM", false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false, "VM", false);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true, "VM", false);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true, "VM", false);

                if (!YesNoOnlyFarm)
                {
                    //CoordCaller(coreStructure, ListRegion, "ThuMua", UpperCap, "VM+ VinEco", YesNoByUnit);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM Priority", false);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM Priority", false);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM Priority", false);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM Priority", false);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM Priority", false);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM Priority", false);

                    //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "ThuMua", MBtoMB, LDtoMB, UpperCap, false, "VM", false);
                    //Coord(coreStructure, "Miền Nam", "Miền Nam", "ThuMua", MNtoMN, LDtoMN, UpperCap, false, "VM", false);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "ThuMua", LDtoMB, LDtoMB, UpperCap, false, "VM", false);
                    //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "ThuMua", LDtoMN, LDtoMN, UpperCap, false, "VM", false);
                    //Coord(coreStructure, "Miền Nam", "Miền Bắc", "ThuMua", MNtoMB, LDtoMB, UpperCap, true, "VM", false);
                    //Coord(coreStructure, "Miền Bắc", "Miền Nam", "ThuMua", MBtoMN, LDtoMN, UpperCap, true, "VM", false);
                }

                CoordCaller(coreStructure, ListRegion, "VinEco", UpperCap, "");

                //Coord(coreStructure, "Miền Bắc", "Miền Bắc", "VinEco", MBtoMB, LDtoMB, UpperCap, false);
                //Coord(coreStructure, "Miền Nam", "Miền Nam", "VinEco", MNtoMN, LDtoMN, UpperCap, false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Bắc", "VinEco", LDtoMB, LDtoMB, UpperCap, false);
                //Coord(coreStructure, "Lâm Đồng", "Miền Nam", "VinEco", LDtoMN, LDtoMN, UpperCap, false);
                //Coord(coreStructure, "Miền Nam", "Miền Bắc", "VinEco", MNtoMB, LDtoMB, UpperCap, true);
                //Coord(coreStructure, "Miền Bắc", "Miền Nam", "VinEco", MBtoMN, LDtoMN, UpperCap, true);
                ...
                if (YesNoReportM1)
                {
                    ...
                    var path = string.Format(
                        @"C:\Users\Shirayuki\Documents\VinEco\Project - Chia Hang\Mastah Project\Test\" + fileName);
                ...
                else
                {
                    if (!YesNoCompact)
                    {
                        ...
                        var missing = Type.Missing;
                        var path = string.Format(
                            @"C:\Users\Shirayuki\Documents\VinEco\Project - Chia Hang\Mastah Project\Test\ChiaHang Mastah {1}{0}.xlsb",
        ...
        private async Task UpdatePO(string fileNameMB, string fileNameMN)
        {
            ...
            try
            {
                ...
                var filePath =
                    string.Format("C:\\Users\\Shirayuki\\Documents\\VinEco\\Project - Chia Hang\\Mastah Project\\{0}",
                        fileNameMB);
                var conStr = string.Format(Constants.Excel07ConString, filePath, header);

                var directoryPath = "C:\\Users\\Shirayuki\\Documents\\VinEco\\Project - Chia Hang\\Mastah Project\\PO";
        ...
        private async Task UpdateFC(string fileVE, string fileTM, bool YesNoPlanning = false)
        {
            ...
            try
            {
                ...
                var defaultPath = "C:\\Users\\Shirayuki\\Documents\\VinEco\\Project - Chia Hang\\Mastah Project\\{0}";
                ...
                //if (!YesNoPlanning)
                //{
                //    filePath = string.Format("C:\\Users\\Shirayuki\\Documents\\VinEco\\Project - Chia Hang\\Mastah Project\\{0}", "ThuMua KPI.xlsb");
                //    conStr = string.Format(Constants.Excel07ConString, filePath, header);
        ...
        ///     Do naughty stuff with PO
        /// </summary>
        private static void EatPOAspose(List<PurchaseOrderDate> PO, Aspose.Cells.Worksheet xlWs, string conStr,
            string PORegion, Dictionary<DateTime, Dictionary<string, Dictionary<string, Guid>>> dicPO,
            Dictionary<string, Product> dicProduct, Dictionary<string, Customer> dicCustomer, List<Product> Product,
            List<Customer> Customer, bool YesNoNew = false)
        {
            try
            {
                ...
                do
                {
                    if (xlWs.Cells[rowIndex, 0].Value == null || xlWs.Cells[rowIndex, 0].Value.ToString() != "VE Code")
                        rowIndex++;
                } while ((xlWs.Cells[rowIndex, 0].Value == null ||
                          xlWs.Cells[rowIndex, 0].Value.ToString() != "VE Code") &&
                         rowIndex <= xlWs.Cells.MaxDataRow + 1);
        ...
        private async Task UpdateDeli()
        {
            try
            {
                ...
                var directoryPath =
                    "C:\\Users\\Shirayuki\\Documents\\VinEco\\Project - Chia Hang\\Mastah Project\\Deli";
        ...
        private void testExportLargeExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var fileName = string.Format("PO {0}.xlsx",
                DateFrom.ToString("dd.MM") + " - " + DateTo.ToString("dd.MM") + " (" +
                DateTime.Now.ToString("yyyyMMdd HH\\hmm") + ")");
            var path = string.Format(@"C:\Users\Shirayuki\Documents\VinEco\Project - Chia Hang\Mastah Project\Test\" +
                                     fileName);
